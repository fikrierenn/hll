      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-white shadow-lg">
              <span className="text-3xl font-bold">AY</span>
            </div>
            <div className="flex-1">
              <h2 className="text-xl font-bold text-gray-900">Ahmet Yıldırım</h2>
              <p className="text-sm text-gray-500">Üst Lider - Organizasyon</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-gray-700">
              ...
              <div>
                ...
                <p className="font-medium">admin@hll.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-gray-700">
              ...
              <div>
                ...
                <p className="font-medium">0588 999 0011</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-gray-700">
              ...
              <div>
                ...
                <p className="font-medium">2 Lider, 5 Temsilci</p>
              </div>
            </div>
          </div>
        </div>
